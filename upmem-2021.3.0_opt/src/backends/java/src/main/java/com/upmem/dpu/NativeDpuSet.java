...
final class NativeDpuSet {
    ...
    native void copy(String dpuSymbol, byte[][] hostBuffers, boolean toDpu, boolean isAsync) throws DpuException;
    native void copy(DpuSymbol dpuSymbol, byte[][] hostBuffers, boolean toDpu, boolean isAsync) throws DpuException;
