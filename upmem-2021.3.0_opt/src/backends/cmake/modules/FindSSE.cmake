...
SET(AVX512F_CODE "
  ...
  int main()
  {
    ...
    a = _mm512_add_ps(a, _mm512_set1_ps(1.f));;
    return 0;
  }
")
...
MACRO(CHECK_SSE lang type flags)
  ...
  IF(NOT ${lang}_${type}_FOUND AND NOT ${lang}_${type}_COMPILES)
    SET(${lang}_${type}_FOUND FALSE CACHE BOOL "${lang} ${type} support")
    SET(${lang}_${type}_COMPILES FALSE CACHE BOOL "${lang} ${type} compilation support")
...
CHECK_SSE(C "AVX512F" " ;-mavx512f;/arch:AVX512F")
CHECK_SSE(C "AVX512BW" " ;-mavx512bw;/arch:AVX512BW")
CHECK_SSE(C "CLFLUSHOPT" " ;-mclflushopt;/arch:CLFLUSHOPT")
...
CHECK_SSE(CXX "AVX512F" " ;-mavx512f;/arch:AVX512F")
CHECK_SSE(CXX "AVX512BW" " ;-mavx512bw;/arch:AVX512BW")
CHECK_SSE(CXX "CLFLUSHOPT" " ;-mclflushopt;/arch:CLFLUSHOPT")
