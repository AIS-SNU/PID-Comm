...
JNIEXPORT void JNICALL
Java_com_upmem_dpu_NativeDpuSet_copy__Ljava_lang_String_2_3_3BZZ(JNIEnv *env,
    jobject this,
    jstring jsymbol,
...
JNIEXPORT void JNICALL
Java_com_upmem_dpu_NativeDpuSet_copy__Lcom_upmem_dpu_DpuSymbol_2_3_3BZZ(JNIEnv *env,
    jobject this,
    jobject jsymbol,
    jobjectArray jarrays,
    jboolean to_dpu,
